...
class TestsTestDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->fileMap = array(
            ...
            'bewe.placeholder.generator.primitive' => 'getBewe_Placeholder_Generator_PrimitiveService.php',
            'bewe.placeholder.generator.sqip' => 'getBewe_Placeholder_Generator_SqipService.php',
            'bewe.placeholder.provider' => 'getBewe_Placeholder_ProviderService.php',
        ...
        $this->aliases = array(
            'bewe.placeholder.generator' => 'bewe.placeholder.generator.primitive',
        );
    }
    ...
    {
        $this->services['router'] = $instance = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, ($this->targetDirs[2].'/../Resources/config/routing.yaml'), array('cache_dir' => $this->targetDirs[0], 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'TestsTestDebugProjectContainerUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'TestsTestDebugProjectContainerUrlMatcher', 'strict_requirements' => true), ($this->privates['router.request_context'] ?? $this->getRouter_RequestContextService()));
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'BernhardWebstudioPlaceholderBundle' => array(
                    'path' => $this->targetDirs[3],
                    'namespace' => 'BernhardWebstudio\\PlaceholderBundle',
                ),
            ); break;
            case 'debug.container.dump': $value = ($this->targetDirs[0].'/TestsTestDebugProjectContainer.xml'); break;
            case 'router.resource': $value = ($this->targetDirs[2].'/../Resources/config/routing.yaml'); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'router.cache_class_prefix' => 'TestsTestDebugProjectContainer',
            'request_listener.http_port' => 80,
            'request_listener.https_port' => 443,
            'bewe_placeholder' => array(
                'iterations' => 5,
